...
/*
 * Function: parseStm
 * Usage: Statement *stmt = parseStm(scanner,state);
 * -------------------------------------------
 * Parses a statement by reading tokens from the scanner. The scanner
 * should be set to ignore whitespace and to scan numbers.
 */
